...
| `docs/PRODUCT_SPEC.md` `docs/USER_RESEARCH.md` | 仕様レビュー参照資料                                                       |
...
| スキル                         | 用途                                                                                 |
| ------------------------------ | ------------------------------------------------------------------------------------ |
| `/spec-all [全体説明]`         | 全体仕様策定・エピック分割・並列可否判断 → `.claude/epics/index.md` + `epic_〇〇.md` |
| `/spec [機能]`                 | 仕様策定・ストーリー分割 → `.claude/temp/specs/[機能名].md`                          |
| `/design [機能]`               | 技術詳細設計（任意）→ `.claude/temp/designs/[機能名].md`                             |
| `/build [機能] - [ストーリー]` | 1 ストーリーの実装・PR 作成                                                          |
| `/code-review [対象]`          | コードレビュー                                                                       |
